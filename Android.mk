...
# Creating prebuilt for dependency: quest-cosmetic-loader - version: 0.2.1
include $(CLEAR_VARS)
LOCAL_MODULE := quest-cosmetic-loader_0_2_1
LOCAL_EXPORT_C_INCLUDES := extern/quest-cosmetic-loader
LOCAL_SRC_FILES := extern/libquest-cosmetic-loader_0_2_1.so
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -isystem 'extern' -I'extern/monkecodegen/include' -DID='"MonkeComputer"' -DVERSION='"1.6.0"' -I'./shared' -I'./extern' -Wno-inaccessible-base -Wno-invalid-offsetof
