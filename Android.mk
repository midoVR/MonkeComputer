...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -isystem 'extern' -I'extern/monkecodegen/include' -DID='"MonkeComputer"' -DVERSION='"1.4.0"' -I'./shared' -I'./extern' -Wno-inaccessible-base -Wno-invalid-offsetof
