...
DECLARE_CLASS_CODEGEN(GorillaUI, CustomRoomView, GorillaUI::Components::View, 
    ...
    DECLARE_INSTANCE_FIELD(int, onJoinRoomFailedIdentifier);
    DECLARE_INSTANCE_FIELD(int, onJoinedRoomIdentifier);
    public:
    ...
    REGISTER_FUNCTION(
        ...
        REGISTER_FIELD(onJoinRoomFailedIdentifier);
        REGISTER_FIELD(onJoinedRoomIdentifier);
    )
)